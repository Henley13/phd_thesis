...
\newacro{MT}{microtubules}
\newacro{PCM}{pericentriolar material}
\newacro{IoU}{Intersection over Union}
\newacro{AP}{Average Precision}
\newacro{CNN}{Convolutional Neural Network} %
\newacro{ISL}{In Silico labeling}
\newacro{RNP}{ribonucleo-protein} %