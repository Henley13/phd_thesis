...
% add an appendix with tsne plot colored with random forest probabilities?
...
% from that of the control random genes (Figure 3D, threshold: p value < 103).
...
% degree of statistical significance (p value < 103). FLNA was the only mRNA
...
% The other protrusion mRNAs were statistically different than the controls (p value < 103),
...
% ranged from 13% (HSP90B1) to 93% (AKAP9). The former value may seem low, but it is nevertheless highly statisti- cally significant (p value of 7.1015).
