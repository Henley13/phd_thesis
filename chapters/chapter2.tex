...
In smFISH images, RNA molecules appear as diffraction limited spots, and for this reason, the detection of individual RNA molecules boils down to spot detection.
%Here, we review different techniques for spot detection.
The problem of spot detection has been largely addressed by different scientific communities; I will therefore start by reviewing different techniques aiming at detecting spots in images. 

I will then point to the shortcomings of existing algorithms when applied to High Content Screening by \ac{FISH} 
and describe the solution I have developed and implemented in \mbox{\emph{bigfish.detection}}.
