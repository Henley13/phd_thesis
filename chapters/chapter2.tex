...
\tw{This section is not very well written. It lacks a convincing structure.}
...
\tw{link the considerations on noise to the logical flow}
...
\tw{bad place?}
Spot detection, especially with fluorescent images, has been addressed by the scientific community through different approaches. \tw{unclear:} Yet, some similitudes can be observed and difficulties remained.
