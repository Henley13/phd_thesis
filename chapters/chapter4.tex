...
As a future work, a first valuable task would be the generation of datasets for validation across cell lines and imaging conditions in order to validate the robustness of a point cloud model. An interesting starting point might be the dataset released in ~\cite{savulescu_interrogating_2021,mah_bento_2022}. 
...
% evelop more insights regarding the use of simulated data for training purpose. 
% development or the sourcing of annotated datasets with various cell lines and imaging conditions.
