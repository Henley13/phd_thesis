...
%tential protrusions, in case I want to simulate this specific pattern.
...
%For example to simulate patterns with a moderate strength, I can simulate between 30\% and 50\% of the \ac{RNA} with the targeted localization bias, and the rest uniformly across the cell.
...
\tw{After re-reading this, I found it a bit confusing. Please check if my version is entirely correct.}
