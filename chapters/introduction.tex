...
% Yet, a diversity of cell types exists, performing different actions.
...
%\footnote{For a complete and general introduction about cellular biology, an interested reader could see~\cite{alberts_molecular_2017}.}.
...
%can convey the blueprint of the future protein outside.
...
%and make the study of a spatial distribution within the cell impossible.
%However, technical improvements are progressively addressing these limitations, 
...
%The design of such large screens enables a systematic study of complex mechanisms and to cope with gene expression stochasticity, as well as heterogeneous \ac{RNA} distribution.
...
%to target and hybridize a transcript.
...
Our collaborators also adapted our smiFISH protocol to 96-well plates, permitting robotized experiments and automated imaging to study hundreds of RNA species~\cite{tsanov_smifish_2016, safieddine_choreography_2021}.
...
%Recent developments in life sciences and technological breakthroughs greatly
...
% In general, the tasks performed with these bioimages can be as varied as the visualization of a living system, the reconstruction of microscopy images, its denoising or the recognition of specific phenotypes.
...
%the subsequent computational analysis should be adapted for one set of images to another.
...
% My analyses support and validate biological insights claimed in these studies about \ac{RNA} localization.
...
% I evaluate the impact of translation inhibitors on \ac{RNA} localization, which provides us with further insight into the role of 
% and help identifying a singular translation-dependent pattern.
