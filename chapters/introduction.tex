...
For an eucaryote cell, the expression of a gene includes two main steps: the \textbf{transcription of a \ac{DNA} sequence into a \ac{RNA}}(in the nucleus) and the \textbf{translation of a \ac{RNA} into a protein}.
